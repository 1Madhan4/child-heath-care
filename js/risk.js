...
const RiskEngine = {
    async calculate(childName) {
        ...
        // Require at least 3 check-ins to produce a meaningful risk score
        // This prevents a single bad day from showing a false "Medium Risk" alarm
        ...
        switch (level) {
            case 'low':
                return {
                    ...
                    text: 'Everything looks okay. Keep tracking daily check-ins to maintain awareness.',
                    alertClass: 'alert-low'
                };
            case 'medium':
                return {
                    icon: '🟡',
                    title: 'Alert School Counselor',
                    text: 'Some concerning patterns detected. Consider scheduling a check-in with the school counselor.',
                    alertClass: 'alert-medium'
                };
            case 'high':
                return {
                    icon: '🔴',
                    title: 'Alert Doctor Immediately',
                    text: 'Significant warning signs detected. Please contact a healthcare professional or school psychologist right away.',
